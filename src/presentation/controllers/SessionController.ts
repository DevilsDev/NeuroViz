...
export class SessionController {
    ...
    private bindEvents(): void {
        ...
        this.addTrackedListener(this.elements.presetSelect, 'change', () => {
            ...
            this.elements.btnApplyPreset.disabled = !(value in BUILTIN_PRESETS);
        });
    ...
    /**
     * Applies the selected preset and automatically starts training.
    ...
    private async applyPresetAndStart(): Promise<void> {
        ...
        try {
            ...
            const fetchBtn = document.getElementById('btn-load-data') as HTMLButtonElement | null;
            fetchBtn?.click();

            await new Promise(resolve => setTimeout(resolve, 800));

            const initBtn = document.getElementById('btn-init') as HTMLButtonElement | null;
            initBtn?.click();
