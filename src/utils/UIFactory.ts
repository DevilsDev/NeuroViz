...
export function getSessionElements(): SessionElements {
  return {
    ...
    iconSun: (getCached<HTMLElement>('icon-sun') || document.getElementById('icon-sun')) as HTMLElement,
    iconMoon: (getCached<HTMLElement>('icon-moon') || document.getElementById('icon-moon')) as HTMLElement,
