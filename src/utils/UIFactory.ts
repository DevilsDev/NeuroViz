...
export function getTrainingElements(): TrainingElements {
  return {
    ...
    btnStartSticky: getCachedOrCreate<HTMLButtonElement>('btn-start-sticky', 'button'),
    btnPauseSticky: getCachedOrCreate<HTMLButtonElement>('btn-pause-sticky', 'button'),
    btnStepSticky: getCachedOrCreate<HTMLButtonElement>('btn-step-sticky', 'button'),
    btnResetSticky: getCachedOrCreate<HTMLButtonElement>('btn-reset-sticky', 'button'),
